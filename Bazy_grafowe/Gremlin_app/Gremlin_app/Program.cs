...
using Gremlin_app.Benchmarks;
using Gremlin_app.Models;


namespace Gremlin_app
{
        ...
        static async Task Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (key == ConsoleKey.D1)
                {
                    ...
                    Console.WriteLine("\nPodaj liczbę danych do wygenerowania (10, 100, 500, 1000):");
                    int count;
                    if (int.TryParse(Console.ReadLine(), out count) && (count == 10 || count == 100 || count ==500 || count == 1000))
                    {
