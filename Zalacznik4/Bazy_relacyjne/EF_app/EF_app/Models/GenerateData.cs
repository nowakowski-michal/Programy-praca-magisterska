...
namespace Ef_app.Models
{
    ...
    {
        //użycie appcontextu zawierajacego odwzorowanie oraz dostęp do bazy
        static AppDbContext context = new AppDbContext();
        //użtkownik podaje w metodzie main ile danych wygenerować
        public int Count { get; set; }
        //funkcja generująca dane
        public void GenerateAllData()
        {
            //czyszczenie bazy poprzez usunięcie i ponowne utworzenie
