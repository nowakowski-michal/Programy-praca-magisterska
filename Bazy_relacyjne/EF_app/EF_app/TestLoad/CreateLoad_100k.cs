...
namespace Ef_app.TestLoad
{
    ...
    public class Create_Load_100k
    {
        ...
        //testy zostaną wykonane wstawiając 100000 danych
        [Params(100000)]
        public int Count { get; set; }


        // metoda czyszcząca bazę danych przed benchmarkiem 
        [GlobalSetup]
        ...
        //czyszczenie zawartości tabel przed każdą iteracją benchmarka 
        [IterationSetup]
        public void ClearTableAndMemory()
        {
